...
namespace Server.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        // Ruta con nombre para permitir CreatedAtRoute si se prefiere
        ...
        public async Task<ActionResult<Customer>> CreateCustomerAsync([FromBody] Customer customer) 
        {
            ...
            // Usar el ID devuelto por la BD (created.CustomerId) en lugar del objeto recibido
            return CreatedAtRoute("GetCustomerById", new { id = created.CustomerId }, created);
        }
